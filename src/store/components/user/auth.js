...
export default {
    ...
    recoveryPass(ctx, data) {
        axios.post('http://libarticle.loc/api/v1/recovery-password', data).then(res => {
    ...
    createPass(ctx, data) {
        axios.post('http://libarticle.loc/api/v1/reset-password/'+data.token, data).then(res => {
    ...
    verifyEmail(ctx) {
        ...
        axios.get('http://libarticle.loc/api/v1/confirm-email', {params: params}).then(response => {
    ...
    registrationUser(ctx, data) {
        ...
        axios.post('http://libarticle.loc/api/v1/registration', data).then(res => {
    ...
    login(ctx, data) {
        console.log('auth data ->', data);
        axios.post('http://libarticle.loc/api/v1/login', data).then(res => {
                ctx.commit('updateUser', res.data)
