<template>
  ...
  <div v-else class="form-control">
    <div class="area-control">
      <input type="text" name="email" id="in-name" required v-model="data.name" :class="['input in-form', {invalid:nValidate}]">
    ...
    <button :class="['sign-in-system btn primary', {'load':loader}]" :disabled="loader" type="submit" @click="enter">
      Реєстрація<loader v-if="loader" class="type-loader" :radius="8" :width="2"></loader>
    </button>

  </div>
  <div class="form-trip">
    <span class="text">Якщо у вас створений акаунт, <router-link to="/login" class="text-to">ввійдіть</router-link></span>
