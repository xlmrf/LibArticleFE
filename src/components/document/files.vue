...
export default {
  ...
  computed:{
    ...mapState(['api_url_v1']),
    fileSize(){
      return (this.files.main.sizeFile / 1024 / 1024).toFixed(2)
    },
    fileModal(){
  ...
  mounted() {
    ...
    console.log('route',this.$route.query.file)
    this.getCites()
  },
  beforeDestroy () {
