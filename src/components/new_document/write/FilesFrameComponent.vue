...
<!--    enctype="multipart/form-data"-->
    <input class="form-control select-input" type="file" id="files" @change="selectedFiles()" accept="application/pdf" ref="files" multiple>
    <div class="document-files-wrapper">
      <div class="files-roll-manager" >
        <div v-if="getFiles.length !== 0" >
          <div class="files-tape">
            <span :class="['item', key === file_id ? 'active' : 'inactive']" v-for="(file, key) in getFiles" @click="file_id = key">{{file.originalNameFile}}</span>
          </div>
          <svg class="document-increment-label" @click="addFile()" xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="#B2B2B2" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="12" y1="5" x2="12" y2="19"></line><line x1="5" y1="12" x2="19" y2="12"></line></svg>
        </div>
...
@keyframes rotate-after {
  ...
  25% {transform: rotateZ(90deg) scaleX(0.96) scaleY(0.97);
  ...
  50% {transform: rotateZ(180deg) scaleX(0.92) scaleY(0.95);
  ...
  75% {transform: rotateZ(270deg) scaleX(0.96) scaleY(0.98);
...
@keyframes rotate-before {
  0% {transform: rotateZ(0deg) scaleX(1) scaleY(1);}
  50% {transform: rotateZ(-180deg) scaleX(0.95) scaleY(0.95);}
  100% {transform: rotateZ(-360deg) scaleX(1) scaleY(1);}
}
